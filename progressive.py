...
parser.add_argument("-baseScale", type=float, default=-2.0, help="base scaling of distribution's logscale to achieve better quality for progressice loading")
parser.add_argument("-exBaseScale", type=float, default=-2.0, help="base scaling of distribution's logscale to achieve better quality for upsampling")
...
parser.add_argument("-exdepth", type=int, default=2, help="num iterations to upsampling")
parser.add_argument("-num", type=int, default=10, help="num of image used")
parser.add_argument("-fix", action='store_true', help="color shift to original image's scheme")
